    ...
    return (
        <Container maxWidth='sm'>
            <Paper elevation={3} sx={{ padding: 4, mt: 4 }}>
                ...
                <Box>
                    <TextField fullWidth label='Name' name='name' margin='normal' required value={formData.name} onChange={handleChange} />
                    <TextField fullWidth label='Surname' name='surname' margin='normal' required value={formData.surname} onChange={handleChange} />
                    <TextField fullWidth label='E-Mail' name='email' margin='normal' required value={formData.email} onChange={handleChange} />
