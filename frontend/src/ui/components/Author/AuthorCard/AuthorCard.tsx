...
import EditAuthorDialog from '../EditAuthorDialog/EditAuthorDailog.tsx';
        ...
        <>
            <Card sx={{ maxWidth: 300, height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <CardActions sx={{ justifyContent: 'space-between' }}>
                    ...
                    {isAdmin && (
                    <Box>
                        <Button startIcon={<EditIcon />} color='warning' onClick={() => setEditAuthorDialogOpen(true)}>Edit</Button>
                        <Button startIcon={<DeleteIcon />} color='error' onClick={() => setDeleteAuthorDialogOpen(true)}>Delete</Button>
                    </Box>
                    )}
                </CardActions>
            </Card>
